...
OddFriends Slack^[_The OddFriends Slack channel is no longer available._]
...
Friends Slack.**^[_The OddFriends Slack channel is no longer available._]
...
**Join channel `#q-a` on the OddBird Friends Slack.**^[_The OddFriends Slack
channel is no longer available._]

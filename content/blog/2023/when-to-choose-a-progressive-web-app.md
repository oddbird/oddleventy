...
in app stores. They can provide push notifications [^push-notifications], offline mode, and a home screen icon.

[^push-notifications]: A *push notification* is an alert (typically a pop-up or other message) generated by an app when the app is not open, notifying the person of a new message, update, etc.

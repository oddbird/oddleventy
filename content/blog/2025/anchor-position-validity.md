...
{% callout 'note', false %}
This may be changing -- in our [Winging It episode](/2025/02/20/winging-it-16/)
with Tab Atkins-Bittner, Tab identified that this restriction may not be
necessary. [I opened a CSS Working Group
issue](https://github.com/w3c/csswg-drafts/issues/11769) proposing a change to
the spec to allow this.
{% endcallout %}

      ...
      (function(e) {
          ...
          n.on('click', (n) => {
            e(
              ...
              !(function(e, n) {
                ...
                const r = e.closest('[aria-controls="'.concat(a, '"]')).length;
                const i = document.contains(e.get(0));
                const s = !e.closest(n).length;
                const o = n.attr('data-auto-closing-exception');
                const l = Boolean(o) && e.closest(o).length;
                !r &&
                  (n.data('auto-closing-on-any-click') || (i && s && !l)) &&
                  t(n);
              })(e(n.target), e(r));
            });
          });
        ...
        var o = function() {
          const n =
            r.a &&
            r.a.sizes &&
            r.a.sizes['layout-sizes'] &&
            r.a.sizes['layout-sizes']['nav-break'];
          if (n) {
            const t = e('#nav');
            const a = e('[aria-controls="nav"]');
            const i = window.matchMedia('(min-width: '.concat(n, ')'));
            const s = function(e) {
              e.matches
    ...
    49(e, n, t) {
      ...
      !(function(e) {
        ...
        (function(e) {
          ...
          const a = {};
          const r = {};
          const i = /^(no-?highlight|plain|text)$/i;
          ...
          function p(e) {
            ...
            !(function r(i, s) {
              ...
              if (i.keywords) {
                ...
                typeof i.keywords === 'string'
                  ? l('keyword', i.keywords)
                  : t(i.keywords).forEach((e) => {
                      l(e, i.keywords[e]);
                    }),
                  (i.keywords = o);
              }
              ...
              s &&
                ...
                i.endsWithParent &&
                  ...
                  (i.terminator_end =
                    i.terminator_end +
                    ((i.end ? '|' : '') + s.terminator_end)));
              i.illegal && (i.illegalRe = a(i.illegal));
              i.relevance == null && (i.relevance = 1);
          ...
          function h(e, n, t, r) {
            ...
            function o() {
              (_ =
                ...
                (E.subLanguage != null
                  ? (function() {
                      const e = typeof E.subLanguage === 'string';
                      if (e && !a[E.subLanguage]) {
                        return d(y);
                      }
                      const n = e
                        ? h(E.subLanguage, y, !0, v[E.subLanguage])
                        : w(y, E.subLanguage.length ? E.subLanguage : void 0);
                      E.relevance > 0 && (x = x + n.relevance);
                      e && (v[E.subLanguage] = n.top);
            ...
            function g(e) {
              (_ = _ + (e.className ? s(e.className, '', !0) : '')),
            ...
            function m(e, n) {
              ...
              if (r) {
                ...
                i.skip
                  ? (y = y + n)
                  : (i.returnEnd || i.excludeEnd || (y = y + n),
                    o(),
                    i.excludeEnd && (y = n));
                do {
                  E.className && (_ = _ + l),
                    E.skip || (x = x + E.relevance),
                    (E = E.parent);
                } while (E !== r.parent);
                return r.starts && g(r.starts), i.returnEnd ? 0 : n.length;
              }
              if (
                (function(e, n) {
                ...
                throw new Error(
                  `Illegal lexeme "${n}" for mode "${E.className ||
                    '<unnamed>'}"`,
                );
              }
            ...
            var v = {};
            var _ = '';
            for (f = E; f !== b; f = f.parent) {
              f.className && (_ = s(f.className, '', !0) + _);
            }
            var y = '';
            var x = 0;
            try {
              for (
                var M, O, k = 0;
                (E.terminators.lastIndex = k), (M = E.terminators.exec(n));

              ) {
                (O = m(n.substring(k, M.index), M[0])), (k = M.index + O);
              }
              for (m(n.substr(k)), f = E; f.parent; f = f.parent) {
                f.className && (_ = _ + l);
              }
              return { relevance: x, value: _, language: e, top: E };
            } catch (e) {
          ...
          function w(e, n) {
            n = n || c.languages || t(a);
            let r = { relevance: 0, value: d(e) };
            let i = r;
            return (
              n.filter(N).forEach((n) => {
                const t = h(n, e, !1);
                (t.language = n),
                  t.relevance > i.relevance && (i = t),
                  t.relevance > r.relevance && ((i = r), (r = t));
              }),
          ...
          function v(e) {
            ...
            const u = (function(e) {
              ...
              let i = `${e.className} `;
              if (
                ((i = i + (e.parentNode ? e.parentNode.className : '')),
                (t = s.exec(i)))
              ) {
                return N(t[1]) ? t[1] : 'no-highlight';
              }
              for (i = i.split(/\s+/), n = 0, a = i.length; n < a; n++) {
                if (m((r = i[n])) || N(r)) {
                  return r;
                }
              }
              ...
              (a = f(t)).length &&
                ...
                (i.value = (function(e, t, a) {
                  ...
                  for (; e.length || t.length; ) {
                    let m = o();
                    if (
                      ((i = i + d(a.substring(r, m[0].offset))),
                      (r = m[0].offset),
                      m === e)
                    ) {
                      s.reverse().forEach(c);
      ...
      (r = this),
        ...
        void 0 ===
          (a = function(e) {
            !(function(e, n) {
              let t, a, r;
              const i = Boolean('srcdoc' in document.createElement('iframe'));
              const s =
              ...
              const l = function(e, n) {
                ...
                typeof t !== 'string' ||
                  ...
                  (n && n.force
                    ...
                    : (n && !1 === n.force) ||
                      (r(s), e.setAttribute('data-srcdoc-polyfill', s)));
              };
              const c = {
                compliant(e, n, t) {
          ...
          return (
            (s.addListener = function(e) {
              n &&
                ...
                l === 0 && (l = r.push({ mql: s, listeners: o })),
                o.push(e));
            }),
    ...
    84(e, n, t) {
      ...
      t.r(n),
        function(e) {
          ...
          const r = t(18);
          e(() => {
            (window.$ = e), a.a.initHighlighting(), r.c(), r.a(), r.b();
          });
        }.call(this, t(16));
    },
  },

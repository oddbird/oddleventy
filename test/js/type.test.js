...
describe('typography filters', () => {
  ...
  test('md', () => {
    const expected = `<div class="anchor-link-wrapper">\n<h2 id="${slugifyd}" tabindex="-1">${typogrd}</h2>\n<a class="header-anchor" href="#lorem-ipsum-dolor-sit-amet%2C-consectetur"><span aria-hidden="true">${anchorLinkIconString}</span> <span class="sr-only">Permalink to “Lorem ipsum dolor sit amet, consectetur”</span></a></div>\n`;
